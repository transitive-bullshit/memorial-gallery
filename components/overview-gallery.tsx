        ...
        {cards.map(({ memory, offsetX, offsetY, rotation }, index) => (
          ...
          >
            <button
              ...
              className='memory-overview-card block w-full appearance-none rounded-[2px] border-0 bg-transparent p-0 text-left outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-4 focus-visible:ring-offset-background'
            >
              <Image
                src={memory.image}
                alt={memory.alt}
